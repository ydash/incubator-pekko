 ...
 * [[ActorSystem#apply[T](guardianBehavior:org\.apache\.pekko\.actor\.typed\.Behavior[T],name:String,bootstrapSetup:org\.apache\.pekko\.actor\.BootstrapSetup)* ActorSystem#apply]]
 * from a [[Behavior]] object that describes the root
