...
trait PersistenceRecovery {
   ...
   * The returned [[pekko.persistence.Recovery Recovery]] object defines how the Actor will recover its persistent state before
...
trait PersistenceStash extends Stash with StashFactory {
  ...
  /**
   * The returned [[pekko.persistence.StashOverflowStrategy StashOverflowStrategy]] object determines how to handle the message failed to stash
